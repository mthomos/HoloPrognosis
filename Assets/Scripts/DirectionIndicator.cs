...
{
    public GameObject Cursor; // GazeCursor
    public GameObject DirectionIndicatorObject; // DirectionIndicator
    ...
    private Vector3 camToObjectDirection;
    ...
    {
        if (directionIndicator == null) return null;
